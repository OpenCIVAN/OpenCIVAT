...
## ⚠️ CRITICAL: PanelShell Architecture

**The Canvas Map uses the NEW PanelShell system** - NOT the old LeftPanel tab pattern.
...
See **Canvas_Map_Panel_Architecture_Clarification.md** and **PanelShell_Unified_Workspace_Design_Session_Memory_Log.md** in project files for details.
...
2. **Handoff:** `/home/claude/Canvas_Map_Claude_Code_Handoff.md`
   - Full implementation specification with PanelShell pattern
   
3. **Atomic Spec:** `/home/claude/Atomic_Component_Spec_Canvas_Map.md`
   - Reusable component definitions

## Reference Project Files (Already in Project)

1. **Canvas_Map_Panel_Architecture_Clarification.md** - PanelShell vs LeftPanel guidance
2. **PanelShell_Unified_Workspace_Design_Session_Memory_Log.md** - Complete panel system design
...
```
I'm continuing work on the Canvas Map panel for CIA Web. 

⚠️ CRITICAL: Use the NEW PanelShell system (NOT LeftPanel tabs).

Please read these project files:
1. Canvas_Map_Panel_Architecture_Clarification.md - PanelShell architecture
2. PanelShell_Unified_Workspace_Design_Session_Memory_Log.md - Full panel system design
3. Canvas_Map_Design_Session_Memory_Log.md - This session's design decisions
...
Implementation uses:
- PanelShell with CHROME_LEVELS.FULL
- Location: panels/CanvasMapPanel/
- Content receives sizeMode prop for responsive behavior
