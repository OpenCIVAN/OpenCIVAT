 ...
 *
 * Each view = exactly 1 cell, positioned at its canvas coordinates.
 * Color based on view type, icon centered, name below (if space).
 */

import React, { memo } from 'react';
import { Icon } from '@UI/react/components/atoms/Icon';
import { VIEW_TYPES, formatCellRef } from '../../CanvasMapTab.logic';
  ...
  return (
    <div
      ...
      style={{
        ...
        '--view-color': view.vgColor || viewType.color,
      }}
      onClick={onClick}
      role="button"
      tabIndex={0}
