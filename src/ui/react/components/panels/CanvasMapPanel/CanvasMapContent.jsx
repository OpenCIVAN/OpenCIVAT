 ...
 * @description Canvas Map content component - renders inside PanelShell
 *
 * Primary Functions:
 ...
 * - Responsive to sizeMode for adaptive layout
 */
...
// Import components from the old location - these will be moved later
import { Minimap } from '../LeftPanel/tabs/CanvasMapTab/components/Minimap';
import { ModeToolbar } from '../LeftPanel/tabs/CanvasMapTab/components/ModeToolbar';
import { NavigatePanel, LayoutPanel, LinksPanel, TeamPanel } from '../LeftPanel/tabs/CanvasMapTab/components/panels';
import {
  useCanvasMapTab,
  MAP_MODES,
  MODE_CONFIG,
  getVGDisplayName,
} from '../LeftPanel/tabs/CanvasMapTab/CanvasMapTab.logic';
import '../LeftPanel/tabs/CanvasMapTab/CanvasMapTab.scss';

/**
 * CanvasMapContent - Content for the Canvas Map panel
 *
 * @param {Object} props
...
export const CanvasMapContent = memo(function CanvasMapContent({
  ...
  if (vgLoading) {
    return (
      <div className="canvas-map" data-vr={isVR} data-size-mode={sizeMode}>
  ...
  // ---------------------------------------------------------------------------
  // Responsive adjustments based on sizeMode
  // ---------------------------------------------------------------------------
