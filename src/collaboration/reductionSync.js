import { yReduction as yReductionMap, yActor as yActorForReduction } from './yjsSetup.js';
...
export function setupReductionSync(toggleCallback, getMethod, getComponents, setMethod, setComponents) {
