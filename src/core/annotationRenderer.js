  ...
  initialize() {
    ...
    annotationSystem.onAnnotationChange((action, annotation) => {
      ...
      if (action === "added") {
        ...
        import("../core/simpleVisualizationManager.js").then((module) => {
          const currentViz =
            module.simpleVisualizationManager.getCurrentDataset();
    ...
    import("../core/simpleVisualizationManager.js").then((module) => {
      const currentViz = module.simpleVisualizationManager.getCurrentDataset();
      const currentDatasetId = currentViz ? currentViz.datasetId : null;
